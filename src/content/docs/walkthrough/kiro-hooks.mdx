...
![Kiro Agent Hooks panel listing PR Readiness Coach hooks](/screenshots/03-kiro-hooks-panel.png)

Full-mode hook run (`PR_READY_HOOK_LOCAL=0`) returning READY with draft PR title/body:

![Kiro or CLI full-mode hook run showing READY verdict](/screenshots/03-hook-run.png)
