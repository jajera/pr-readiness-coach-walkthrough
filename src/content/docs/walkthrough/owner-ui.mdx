...
![Amplify owner UI runs list showing mixed readiness verdicts](/screenshots/01-amplify-ui.png)

Try it — `POST /ui/analyze` with Cognito JWT:

![Amplify Try it panel posting analyze with Cognito JWT](/screenshots/01-amplify-try-it.png)
