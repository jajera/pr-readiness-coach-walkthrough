...
| Prefer not to use AdminAccess for CI | Deploy role too wide | Use the minimum deploy IAM policy ([Deploy IAM Policy](/reference/deploy-iam-policy/)); bootstrap stays a one-time wider admin step |
