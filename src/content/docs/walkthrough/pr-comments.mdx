...
![GitHub Actions PR comment showing READY verdict](/pr-readiness-coach-walkthrough/screenshots/02-pr-comment-ready.png)

Comment with coach warnings (job still green — warn-only):

![GitHub Actions PR comment showing READY WITH WARNINGS](/pr-readiness-coach-walkthrough/screenshots/02-pr-comment-warnings.png)
