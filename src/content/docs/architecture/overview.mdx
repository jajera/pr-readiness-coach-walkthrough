...
Infrastructure is AWS CDK (TypeScript) in `ap-southeast-2`:
...
Editable diagram source for this site: `docs/pr-readiness-architecture.drawio` (SVG served from `public/diagrams/`).
