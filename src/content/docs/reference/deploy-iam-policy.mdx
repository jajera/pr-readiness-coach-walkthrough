...
description: Full minimum IAM permissions JSON for the GitHub Actions OIDC deploy role used by PrReadinessCoachStack.
---
...
See [GitHub OIDC](/walkthrough/github-oidc/) for trust policy setup and secrets.
